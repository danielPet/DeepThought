...
inst_needs_relocation:
	...
	addiu $t1, $0, 3
        ...
        beq $t2, $t0, needs_reloc
        beq $t2, $t1, needs_reloc
...
relocate_inst:
	...
	beq $v0, $t0, reloc_error
        ...
        # Get the opcode from $a0 by getting the top six bits.
        andi $t0, $a0, 0xfc000000 # $t0 is the opcode. 
        andi $t1, $v0, 0x0fffffff # This will get the last 28 bits. 
        srl $t1, $t1, 2 # Dividing by 4. Getting rid of the last two bits.
        or $t1, $t1, $t0  # The 26 bit immediate would have 6 0s in the front so using or will just add the opcode and the immediate.
        move $v0, $t1
